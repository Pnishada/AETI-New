...
SECRET_KEY = 'django-insecure-xht)22sa_hp*6+3w3+bkc-q7=n*j(rtq$6==8&$4zjc(eo5a28'
...
# CORS configuration
# Allow frontend (React/Vite) to communicate with Django backend
...
# REST Framework settings (optional, for API projects)
REST_FRAMEWORK = {
